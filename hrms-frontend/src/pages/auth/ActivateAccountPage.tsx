  ...
  return (
    <form onSubmit={handleActivate} className="space-y-4">
      <div className="text-center mb-4">
        ...
        <p className="text-xs text-slate-500 mt-1">Complete your registration to access Cyrcalur HRMS.</p>
      </div>
      ...
      <FormField label="Set Initial Password" required helperText="At least 8 characters">
        <Input
          type="password"
          value={password}
